          ...
          IconButton(
              onPressed: () async {
                if (type == 0){
                  ...
                  if (query == -1){
                    var awaitSavedJSON = r'''{"title":"'''+title+'''","agency":"'''+agency+'''","date":"'''+date+'''","actualContent":"'''+content[0].trim()+'''',"link":"'''+link+'''"}''';
                  ...
                  if (query == -1){
                    var awaitSavedJSON = r'''{"title":"'''+title+'''","agency":"'''+agency+'''","date":"'''+date+'''","actualContent":"'''+content[0].toString()+'''","link":"'''+link+'''"}''';
