...
Future<List<ScheduleItem>> calResult = Future.value([
  ScheduleItem(
      year: "0", month: "0", day: "0", dayOfWeek: "0", details: [], exam: [])
]);
...
Future<List<ScheduleItem>> getCal() async {
  ...
  for (var h = 12; h < TDs.length; h = h + 12) {
    //decide day of week
    var newDayOfWeek = "";
    if (trimStr(TDs[h + 3].innerHtml, 44, 7).contains("FF0001") ||
        trimStr(TDs[h + 3].innerHtml, 44, 7).contains("0001FF")) {
            ...
            SliverToBoxAdapter(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  ChoiceChip(
                    label: Text("高三"),
                    selected: selectedGrade == 6,
                    onSelected: (selected) {
                      setState(() {
                        selectedGrade = (selected ? 6 : null)!;
                      });
                      saveSel(6);
                    },
                  ),
                                                        ...
                                                        child: Padding(
                                                          padding:
                                                              EdgeInsets.all(
                                                                  10),
                                                          child: trimStr(
                                                                      snapshot.data![index].exam[
                                                                              selectedGrade]
                                                                          [
                                                                          index3],
                                                                      0,
                                                                      snapshot.data![index]
                                                                              .exam[selectedGrade][index3]
                                                                              .toString()
                                                                              .length -
                                                                          1) ==
                                                                  "段"
                                                              ...
                                                              : Text(
                                                                  "第" +
                                                                      trimStr(
                                                                          snapshot.data![index].exam[selectedGrade]
                                                                              [
                                                                              index3],
                                                                          0,
                                                                          snapshot.data![index].exam[selectedGrade][index3].toString().length -
                                                                              1) +
                                                                      "節：" +
                                                                      trimStr(
                                                                          snapshot
